		...
		foreach($respuesta as $row => $item) {
			...
			echo ' 
			 <tr>
                ...
                <td>22/Abr/2017</td>
                <td>
                <button type="button" class="btn waves-effect waves-light btn-xs btn-info"><i class="fa fa-edit"></i></button>
                <button type="button" class="btn waves-effect waves-light btn-xs btn-danger"><i class="fa fa-times"></i> </button>
