        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Inscritos</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item">Inscritos</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Listado de Inscritos</h4>
...
<div id="suscriptores" class="col-lg-12 col-md-10 col-sm-9 col-xs-12">
 ...
 <div>
    ...
    <tbody>
      ...
      $inscripciones -> mostrarInscripcionesController();
      $inscripciones -> borrarInscripcionesController();
