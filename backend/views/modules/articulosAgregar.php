                                        ...
                                        <div class="row">
                                            <div class="col-lg-6     col-md-6">
                                                    <label for="input-file-now">Imagen Principal del Artículo — formatos jpg o png</label>
                                                        ...
                                                        <input type="file" id="input-file-now" class="dropify" name="imagen" accept="image/jpeg , image/png" value="2097153" /><small>Tamaño recomendado: 600px * 400px, peso máximo 2MB</small>
                                                    </div>
