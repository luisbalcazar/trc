		...
		$.ajax({
			...
			success: function(respuesta){
				...
				if(respuesta == 0){
					...
					$("#ordenarTextSlide").append('<li><span class="fa fa-pencil" style="background:blue"></span><img src="'+respuesta["ruta"].slice(6)+'" style="float:left; margin-bottom:10px" width="80%"><h3>'+respuesta["titulo"]+'</h3><p>'+respuesta["descripcion"]+'</p></li>');
...
$(".editarSlide").click(function(){
	...
	rutaTitulo = $(this).parent().children("h3").html();
	...
	$("#guardar"+idSlide).click(function(){
		...
		$.ajax({
			...
			success: function(respuesta){
				...
				$("#guardar"+idSlide).parent().html('<span class="fa fa-pencil editarSlide" style="background:blue"></span><img src="'+rutaImagen+'" style="float:left; margin-bottom:10px" width="80%"><h3>'+respuesta["titulo"]+'</h3><p>'+respuesta["descripcion"]+'</p>');
