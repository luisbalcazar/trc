...
<div class='slide_form2'>
		...
		<span style="color:#fff; font-size: 30px; letter-spacing: 5px; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; text-transform: uppercase; text-shadow: 0.8px 2px 1px #000 !important;">Renta de vehiculos en Florida</span>
		<br>
		...
		<div class='row'>
			...
			<div class='form-group col-12' style="width: 95%; margin-bottom: -3px;">
				<span class="slide_span" style=''>LUGAR DE RECOGIDA</span><br>
				<select name='locPickup' id='locPickup' class='form-control caja2' required>
					<?php 
						$locacions = new locacionController();
						$locacions -> mostrarLocacionController();
					?>
			...
			<div class='form-group col-12'style="width: 95%;">
				<input type='hidden' name='Pick' id='Pick'><br>

				<span id='recogida_text' class="slide_span2">FECHA DE RECOGIDA</span><br>

				<input type='text' class='form-control caja2' name='start' id='start'  required placeholder='Ej: 12/09/2018 10:00'>
			</div>

							
			<div class='form-group col-12'style="width: 95%; margin-bottom: -3px;">
				<span class="slide_span">LUGAR DE ENTREGA</span><br>
				<select name='locDropoff' id ='locDropoff' class='form-control caja2' required >";
						<?php 
						$locacions2 = new locacionController();
						$locacions2 -> mostrarLocacionController();
						?>
			...
			<div class='form-group col-12' style="width: 95%;">
					...
					<span class="slide_span2">FECHA DE ENTREGA</span><br>
					<input type='text' class='form-control caja2' name='end' id='end' required  placeholder='Ej: 12/09/2018 10:00'>
			</div>
